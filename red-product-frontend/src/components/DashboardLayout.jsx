          ...
          <div className="flex items-center gap-6">
            ...
            <div className="relative">
              <button 
                ...
                className="relative p-1.5 text-gray-600 hover:text-gray-800 transition"
              >
                  ...
                  <div className="max-h-60 overflow-y-auto mt-2">
                    {notifications.length === 0 ? (
                      ...
                      notifications.map((n) => (
                        <div 
                          key={n.id} 
                          className={`px-4 py-2.5 hover:bg-gray-50 transition border-b border-gray-50/50 last:border-0 ${
